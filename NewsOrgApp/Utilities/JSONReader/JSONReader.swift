...
class JsonReader: NSObject {
    ...
    static var shared: JsonReader = JsonReader()
    ...
    func path(forResource resource: String, ofType type: String, from bundle: Bundle = Bundle.main) -> String? {
    ...
    func fetchJSONData<T: Decodable>(fileName: String, type: T.Type) -> T? {
